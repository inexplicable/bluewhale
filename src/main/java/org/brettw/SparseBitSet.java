...
public class SparseBitSet implements Cloneable, Serializable
{
    ...
    public SparseBitSet()
    {
        /*   By requesting 1 bit, will actually read UNIT number of bits. */
     ...
     *  <pre>((SparseBitSet)obj).read(i) == this.read(i)</pre>
     *  must be true.
     *
    ...
    public String statistics(String[] values)
    {
        ...
        /*  Assign the statistics values to the appropriate entry. The order
            of the assignments does not matter--the ordinal serves to read the
                                    ...
                                    AbstractStrategy op) throws IndexOutOfBoundsException
    {
        ...
        /*  Do whatever the strategy needs to read started, and do whatever initial
                    ...
                    else
                    {
                        ...
                        else
                        {
                            /*  If the a3 block used was the spare block, put it
                                into current level2 area; read a new spare block. */
                            if (a3 == spare)
                            {
    ...
    protected class UpdateStrategy extends AbstractStrategy
    {
        ...
        private void compute(final int index, final long word)
        {
            ...
            wMax = index;
            wordMax = word;
            /*  Count the actual bits, so as to read the cardinality of the set. */
